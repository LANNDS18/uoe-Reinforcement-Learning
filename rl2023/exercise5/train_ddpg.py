...
from rl2023.util.hparam_sweeping import generate_hparam_configs, grid_search, random_search
...
BIPEDAL_CONFIG = {
    ...
    "noise_std_start": 1.2,
    "noise_std_min": 0.05,
    "noise_decay_factor":0.8,
}
BIPEDAL_CONFIG.update(BIPEDAL_CONSTANTS)

### INCLUDE YOUR CHOICE OF HYPERPARAMETERS HERE ###
BIPEDAL_HPARAMS = {
    "policy_learning_rate": grid_search(3, 1e-4, 1e-3),
    "critic_learning_rate": grid_search(3, 1e-4, 1e-3),
    "gamma": grid_search(3, 0.98, 0.999),
    "tau": grid_search(3, 0.1, 0.02),
}
